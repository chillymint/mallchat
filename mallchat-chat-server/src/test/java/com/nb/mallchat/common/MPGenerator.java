...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/zongzibinbin\">cc</a>");
        ...
        packageConfig.setParent("com.nb.mallchat.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        //远程环境ip 124.221.157.215；mp代码生成器连接不上远程，这里本地也建了一份相同的库表来mp代码生成
