...
import com.nb.mallchat.common.user.domain.enums.ApplyStatusEnum;
import com.nb.mallchat.common.user.domain.enums.ApplyTypeEnum;
import com.nb.mallchat.common.user.mapper.UserApplyMapper;
...
public class UserApplyDao extends ServiceImpl<UserApplyMapper, UserApply> {
	...
	public void readApples(Long uid, List<Long> applyIds) {
		lambdaUpdate()
				.set(UserApply::getReadStatus, 0)
				.eq(UserApply::getReadStatus, 1)
	...
	public void agree(Long applyId) {
		lambdaUpdate().set(UserApply::getStatus, 1)
