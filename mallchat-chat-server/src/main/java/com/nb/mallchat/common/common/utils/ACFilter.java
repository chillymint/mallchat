...
import com.nb.mallchat.common.common.domain.ACTrie;
...
public class ACFilter implements SensitiveWordFilter {
	...
	public String filter(String text) {
		...
		for (MatchResult matchResult : matchResults) {
			endIndex = Math.max(endIndex, matchResult.groupCount());
			replaceBetween(result, matchResult.groupCount(), endIndex);
		}
